...
public class Global
{
    ...
    public const string LegacyAppName = "v2rayN";
    ...
    public const string AutoRunName = "freedomAutoRun";
    public const string LegacyAutoRunName = "v2rayNAutoRun";
    ...
    public const string UseLocalAppDataArgument = "--use-local-app-data";
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.v2rayN, "qhs200312/freedom-winui" },
    };
